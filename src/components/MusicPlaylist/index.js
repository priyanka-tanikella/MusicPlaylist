...
class MusicPlaylist extends Component {
  ...
  clickDeleteIcon = id => {
    ...
    const filteredList = tracksList.filter(eachTrack => eachTrack.id !== id)
  ...
  renderNoSongsFoundView = () => (
    <div className="no-songs-found-view-container">
  ...
  render() {
    ...
    const showMusicPlaylist = searchResults.length > 0

    return (
      <div className="music-playlist-container">
        <div className="music-playlist-background-container">
        ...
        <div className="songs-playlist-container">
          ...
          {showMusicPlaylist
            ? this.renderMusicPlaylistView(searchResults)
